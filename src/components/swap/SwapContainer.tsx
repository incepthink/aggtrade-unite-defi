...
import ClassicSwap from "./swapTypes/ClassicSwap/ClassicSwap";
...
const SwapContainer: React.FC<SwapContainerProps> = ({ onTabChange }) => {
  ...
  return (
    <Stack spacing={{ xs: 2, sm: 2 }} sx={{ height: "100%" }}>
      ...
      {/* Main Content - Single Column Layout for All Tabs */}
      <Box sx={{ flex: 1 }}>
        <div className="bg-gray-900/80 backdrop-blur-sm border border-gray-700/50 rounded-2xl overflow-hidden h-full">
          {renderSwapComponent()}
        </div>
      </Box>
